...
function github_issues_func(  $atts, $gh=null ) {
    ...
    if ( empty($issues) )
        return "<strong>" . __("No issues to show", 'call-github') . "</strong>";
...
function gh_plugin_options() {
    ...
    ?>
        <div id="message" class="updated notice is-dismissible">
            <p><?php _e("Settings updated!", "call-github"); ?></p>
            <button type="button" class="notice-dismiss">
                <span class="screen-reader-text"><?php _e("Dismiss this notice.", "call-github"); ?></span>
            </button>
        </div>
    <?php
    }
    ...
    <form method="post" action="<?php echo admin_url( 'admin-post.php'); ?>">
        ...
        <h3><?php _e("Github Repository Info", "call-github"); ?></h3>
        <p>
        <label><?php _e("Github Organization:", "call-github"); ?></label>
        <input class="" type="text" name="gh_org" value="<?php echo get_option('gh_org'); ?>" />
        </p>

        <p>
        <label><?php _e("Github repository (slug):", "call-github"); ?></label>
        <input class="" type="text" name="gh_repo" value="<?php echo get_option('gh_repo'); ?>" />
        </p>

        <input class="button button-primary" type="submit" value="<?php _e("Save", "call-github"); ?>" />
    ...
    <form method="post" action="<?php echo admin_url( 'admin-post.php'); ?>">
        ...
        <p>
            <label><?php _e("Github Application Client ID:", "call-github"); ?></label>
            <input class="" type="text" name="client_id" value="<?php echo get_option('client_id')?>" />
        </p>
        <p>
            <label><?php _e("Github Application Client Secret:", "call-github"); ?></label>
            <input class="" type="password" name="client_secret" value="<?php echo get_option('client_secret')?>" />
        </p>
            

        <input class="button button-primary" type="submit" value="<?php _e("Authorize", "call-github"); ?>" />
